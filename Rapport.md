...
# Bilan énergétique
Le système étudié transmet des données toutes les minute. Le bilan énergétique repose sur trois principaux composants : le module LoRaWAN, le microcontrôleur STM32 et le module GPS. Voici une analyse détaillée des sources de consommation énergétique de ces éléments :
...
- **Mode actif** : pendant 1 seconde par cycle de 1 minutes, le module consomme **214 μA/MHz**, soit une consommation énergétique totale de **185.75 mAs** avec un frequence de communication LoraWan de 868 MHz.  
- **Mode veille** : durant les 59 secondes restantes, la consommation chute à **0.9 μA**, correspondant à **107.1 μAs**.  

Consommation totale pour le module LoRaWAN : **185.75 mAs** par cycle de 1 minutes.  

## 2. Microcontrôleur STM32
Le microcontrôleur STM32, responsable de la gestion des opérations et de la coordination des modules, fonctionne de manière continue pendant le cycle de 1 minutes. Sa consommation est stable à **60 μA**, ce qui correspond à une consommation énergétique totale de **3600 μAs**.  

## 3. Module GPS
Le module GPS, utilisé pour obtenir les coordonnées de localisation, est actif pendant moins d'une secondes par cycle. Il consomme **40 mA**, soit une énergie totale de **40 mAs** en suposant le temp d'actif vaut 1 s.  
